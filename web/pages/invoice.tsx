import { Box, Container, Grid, Stack, Table, TableBody, TableCell, TableContainer, TableFooter, TableHead, TableRow, Typography } from '@mui/material';
...
const Invoice: NextPage = () => {
  ...
  return (
    <Container>
      <Typography variant='h2' display='flex' justifyContent='center'>請求書</Typography>

      <Box display='flex' justifyContent="flex-end">
        <Grid container columns={2} alignItems='center' columnSpacing={1} maxWidth='18rem' >
          ...
          <Grid item xs={1} display='flex' justifyContent='center'>
            <Typography>2022年03月10日</Typography>
          </Grid>
        </Grid>
      </Box>

      <Stack direction='row' spacing={2} display='flex' justifyContent='center' alignItems='center' borderBottom={1} maxWidth='18rem'>
      ...
      <Box mt={2} display='flex' justifyContent='space-between' >
        ...
        <Box display='flex' justifyContent='flex-end' maxWidth='18rem'>
          <Box>
        ...
        <Table>
          ...
          <TableFooter>
            <TableRow>
              ...
              <TableCell colSpan={2} align="right" sx={{ background: 'skyblue' }}>
                <Typography sx={{ fontWeight: 'bold' }}>合計</Typography>
              </TableCell>
              <TableCell align="right">
                <Typography sx={{ fontWeight: 'bold' }}>¥ 10000</Typography>
              </TableCell>
            </TableRow>
          </TableFooter>
        </Table>
